...
[ATOK 2026の公式機能説明](https://www.atok.com/features/)は、確定した`アルプス`に続く
`のやま`を`の山`とする文脈変換に加え、話し言葉の`大丈夫、自信持てって`を変換例として
掲げている。[azooKey Desktop v0.1.4](https://github.com/azooKey/azooKey-Desktop/releases/tag/v0.1.4)
もZenzai v3.2と入力予測を導入した。実装元の
[PR #284](https://github.com/azooKey/azooKey-Desktop/pull/284)は、Zenzaiが
